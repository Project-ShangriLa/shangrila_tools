...
masters.each do |master|
 val_title += sprintf('        WHEN tweet_text CONTAINS \'%s\' OR tweet_text CONTAINS \'%s\'  OR tweet_text CONTAINS \'%s\' OR tweet_text CONTAINS \'%s\' OR tweet_text CONTAINS \'%s\' THEN %d' + "\n",
  master['title'],
